...
public class Cesta {
	...
	public void setAddArticulo(int codigoArticulo, int cantidad){
		if (carrito.get(codigoArticulo) == null) { // primera vez
			carrito.put(codigoArticulo,cantidad);
		} else { // resto de veces
			carrito.replace(codigoArticulo,carrito.get(codigoArticulo)+cantidad);
		}
