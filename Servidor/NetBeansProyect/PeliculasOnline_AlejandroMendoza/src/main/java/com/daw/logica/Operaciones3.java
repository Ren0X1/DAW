...
import com.daw.DAO.PeliculageneroJpaController;
...
public class Operaciones3 extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PeliculageneroJpaController ctrPeliculas = new PeliculageneroJpaController(emf);
        List listaPeliculas = ctrPeliculas.findPeliculageneroEntities();
