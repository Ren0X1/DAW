 ...
 */
package com.daw.tiendaonlinebdjpa.filtros;

import com.daw.tiendaonlinebdjpa.DTO.Cliente;
 ...
 * @author Lola
 */
@WebFilter(filterName = "logueo", urlPatterns = {""})
public class logueo implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpSession miSesion = ((HttpServletRequest) request).getSession();
        Cliente usuario = (Cliente) miSesion.getAttribute("client");
        if (usuario != null) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("logueo: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("logueo(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("logueo::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("logueo::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("logueo::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("logueo::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("logueo::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
