...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.login", query = "SELECT u FROM Usuarios u WHERE u.dniusuario = :dniusuario and u.passusuario = :passusuario")
})
public class Usuarios implements Serializable {
    ...
    public String toString() {
        return "com.daw.subidaarchivosjsf.DTO.Usuarios[ dniusuario=" + dniusuario + " ]";
    }
