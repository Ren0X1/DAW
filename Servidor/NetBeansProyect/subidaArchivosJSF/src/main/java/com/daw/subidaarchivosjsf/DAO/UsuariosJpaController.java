...
public class UsuariosJpaController implements Serializable {
    ...
    public void create(Usuarios usuarios) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findUsuarios(usuarios.getDniusuario()) != null) {
    ...
    public void edit(Usuarios usuarios) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = usuarios.getDniusuario();
    ...
    public List<Usuarios> comprobarUser(String dni, String password) {
        EntityManager em = getEntityManager();
        TypedQuery q = em.createNamedQuery("Usuarios.login", Usuarios.class);
