...
import com.daw.DAO.PeliculasdetalleJpaController;
...
public class Operaciones extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PeliculasdetalleJpaController ctrPeliculas = new PeliculasdetalleJpaController(emf);
        List listaPeliculas = ctrPeliculas.findPeliculasdetalleEntities();
