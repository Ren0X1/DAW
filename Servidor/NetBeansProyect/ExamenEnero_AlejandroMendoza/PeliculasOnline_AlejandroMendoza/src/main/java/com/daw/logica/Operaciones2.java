...
import com.daw.DAO.PeliculadirectorJpaController;
...
public class Operaciones2 extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PeliculadirectorJpaController ctrPeliculas = new PeliculadirectorJpaController(emf);
        List listaPeliculas = ctrPeliculas.findPeliculadirectorEntities();
