...
public class Articulo implements Serializable {
    ...
    public String nombreProv(int c) {
        final Utilidades utils_ = new Utilidades();
        return utils_.getCtrProveedor().findProveedor(c).getNombreProveedor();
    }
    
    @Override
    public String toString() {
        return "com.daw.crudtable_primefaces_alejandromendoza_lauramedina.DTO.Articulo[ codArticulo=" + codArticulo + " ]";
    }
